...
<!-- Animated Banner -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:1a1a2e,100:16213e&height=220&section=header&text=Alvin%20Isac%20PREMSUNDER&fontSize=42&fontColor=00d4ff&animation=twinkling&fontAlignY=38&desc=Robotics%20Engineer%20%7C%20ROS2%20%7C%20UAV%20Control%20%7C%20Autonomous%20Systems&descAlignY=58&descSize=16&descColor=a0c4ff" width="100%"/>

<!-- Typing SVG -->
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=00D4FF&center=true&vCenter=true&random=false&width=700&lines=Robotics+Engineer+%F0%9F%A4%96;ROS2+%7C+PX4+%7C+Gazebo+%F0%9F%9A%80;UAV+Control+%26+Autonomous+Systems+%F0%9F%9B%A9%EF%B8%8F;EMARO+Erasmus+Mundus+Scholar+%F0%9F%8C%8D;Open+to+Global+Opportunities+%F0%9F%8C%90" alt="Typing SVG" />
</a>
...
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/AlvinIsac?tab=repositories)
...
class AlvinIsac:
    def __init__(self):
        self.name       = "Alvin Isac PREMSUNDER"
        self.age        = 26
...
![SLAM](https://img.shields.io/badge/SLAM-8A2BE2?style=for-the-badge&logo=ros&logoColor=white)
![Nav2](https://img.shields.io/badge/Navigation2-22314E?style=for-the-badge&logo=ros&logoColor=white)
![PX4](https://img.shields.io/badge/PX4-purple?style=for-the-badge&logo=drone&logoColor=white)
![QGroundControl](https://img.shields.io/badge/QGroundControl-red?style=for-the-badge&logoColor=white)
![Rviz2](https://img.shields.io/badge/Rviz2-0078D7?style=for-the-badge&logoColor=white)
...
![SLAM](https://img.shields.io/badge/SLAM-FF6B6B?style=for-the-badge&logoColor=white)
![Machine Learning](https://img.shields.io/badge/Machine%20Learning-FF9500?style=for-the-badge&logo=scikitlearn&logoColor=white)
...
### 🛸 Multi-UAV Fault-Tolerant MPC Controller
**@ Genova Robotics & Automation Lab** *(Feb 2025 – Oct 2025)*

> Developed a fault-tolerant **MPC controller** achieving aggressive stabilization up to **90% immediately** after one UAV failure, using **full nonlinear dynamics** and **elastic cable tension modeling**.

**Tools:** `ROS2` `PX4` `Gazebo` `MATLAB/Simulink` `CasADi` `IPOPT` `Python` `C++`
...
> This project, completed as part of my Master's Degree in Machine Learning at UNIGE (University of Genoa). The implementation focuses on comparing the performance of **Support Vector Machines (SVM) and K-Nearest Neighbors (KNN)** for classifying images across 10 distinct animal categories.
...
### 🫀 BioMedical Robotics – EMG & Phantom Control
<!-- *(2024)* -->

> Developed **EMG signal processing** and **PHANToM haptic robot** control systems in MATLAB/Simulink. Includes tendon-driven exoskeleton design, force feedback implementation for rehabilitation robotics.
...
### 🗺️ Autonomous Navigation & Aruco Marker Detection
<!-- *(Jan 2025)* -->

> Built a **2D occupancy grid map** with SLAM + LiDAR, implemented **Nav2 + AMCL** for autonomous waypoint navigation and Aruco marker detection using **OpenCV2** — validated on both Gazebo and real robot.
...
### 🤖 ROS1 → ROS2 Migration of TurtleBot2
<!-- *(May 2024)* -->

> Migrated TurtleBot2 from **ROS1 to ROS2 Humble** on Raspberry Pi 3+, corrected URDF/Xacro robot descriptions, precisely aligned Kinect and Hokuyo LiDAR frames in Rviz for autonomous navigation.

**Tools:** `ROS2 Humble` `ROS1` `Raspberry Pi 3+` `URDF/Xacro` `Rviz2` `Packer` `Embedded Linux`

[![Repo](https://img.shields.io/badge/GitHub-View%20Repo-181717?style=flat-square&logo=github)](https://github.com/AlvinIsac/TurtleBot2-ROS2-Migration)
...
<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/AlvinIsac/AlvinIsac/output/github-contribution-grid-snake.svg">
  <img alt="Snake animation" src="https://raw.githubusercontent.com/AlvinIsac/AlvinIsac/output/github-contribution-grid-snake-dark.svg">
</picture>
...
📞 (+33) 780748341 &nbsp;|&nbsp; (+91) 9444114311  
📍 Nantes, France &nbsp;|&nbsp; Work Authorization: APS (France)
...
![Profile Views](https://komarev.com/ghpvc/?username=AlvinIsac&color=00d4ff&style=for-the-badge&label=PROFILE+VIEWS)
